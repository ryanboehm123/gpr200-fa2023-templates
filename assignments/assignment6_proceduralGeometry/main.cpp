...
int main() {
	...
	//Create sphere
	ew::MeshData sphereMeshData = rbLib::createSphere(5, 32);
	...
	planeTransform.position = ew::Vec3(1.0f, -2.0f, 0.0f);
	cylinderTransform.position = ew::Vec3(10.0f, 0.0f, 0.0f);
	sphereTransform.position = ew::Vec3(20.0f, 0.0f, 0.0f);
